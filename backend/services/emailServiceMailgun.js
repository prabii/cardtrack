...
// Send OTP email with Mailgun
const sendOTPEmail = async (email, otp) => {
  try {
    const data = {
      from: process.env.EMAIL_FROM || 'CardTracker Pro <noreply@cardtrackerpro.com>',
      to: email,
    ...
    console.log('OTP email sent successfully via Mailgun:', result.id);
